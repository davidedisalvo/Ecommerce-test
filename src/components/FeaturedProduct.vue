<template>
  <div class="featuredProduct">
    <b-container>
      <b-row>
        <b-col :key="item.fields.title + index" col lg="4" v-for="(item, index) in list">
          <b-card
          ...
          >
            ...
            <b-card-text>{{item.fields.price}}€</b-card-text>

            <b-button href="#" variant="primary">
              <router-link :to="`/singleProduct/${item.sys.id}`" tag="span">Product details</router-link>
            </b-button>
